...
/**
 * Test de prueba de la navegacion de la app (jwebunit)
 * Comprueba que la navegacion sea correcta
...
public class NavegacionBT extends TestCase {
	...
	private static final String BASE_URL="http://localhost:8080/autentia-prueba17";
	...
	public void testNuevoDato() {
		...
		tester.assertTitleEquals("A�adir nuevo dato");
